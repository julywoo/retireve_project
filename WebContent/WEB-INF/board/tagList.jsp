...
<%
	...
	List<BoardVO> tagList=(List<BoardVO>)request.getAttribute("tagList");
...
<form method="post" action="/retrieve/board?method=regist"  id="replySection" style="display: none;">
				...
				<span><input type="text" style="width: 70%;height: 40px" class="" placeholder="댓글을 입력하세요" name="content"/></span>
				...
				<input type="text" style="width: 70%;height: 40px" class="" name="content" placeholder="검색 항목을 입력하세요 "/>
